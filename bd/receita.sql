...
CREATE VIEW vw_receitas_ingredientes AS
SELECT ri.receita_id AS receita_id,ri.ingrediente_id AS ingrediente_id,i.nome AS nome,ri.quantidade AS quantidade,ri.unidade AS unidade
FROM receitas_ingredientes ri LEFT OUTER JOIN ingredientes i ON i.id = ri.ingrediente_id;
